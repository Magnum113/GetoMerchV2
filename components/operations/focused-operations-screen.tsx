        ...
        <div className="mb-8">
          <div className="flex items-center justify-between mb-4">
            <div className="space-y-1">
              <h1 className="text-3xl font-bold tracking-tight text-gray-900">Ежедневные операции</h1>
              <p className="text-gray-600">Что нужно сделать сегодня</p>
            </div>
            <Button
            ...
            <CardHeader className="border-b border-gray-100 bg-gradient-to-r from-green-50 to-green-100/30 pb-4">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <CardTitle className="text-lg font-semibold text-gray-900">Отправить сегодня</CardTitle>
                  ...
                  {readyToShip.map((order) => (
                    ...
                    >
                      <div className="flex-1">
                        <p className="font-semibold text-gray-900 mb-1">Заказ {order.order_number}</p>
            ...
            <CardHeader className="border-b border-gray-100 bg-gradient-to-r from-blue-50 to-blue-100/30 pb-4">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <CardTitle className="text-lg font-semibold text-gray-900">Произвести</CardTitle>
            ...
            <CardHeader className="border-b border-gray-100 bg-gradient-to-r from-red-50 to-red-100/30 pb-4">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <CardTitle className="text-lg font-semibold text-gray-900">Нужно заказать</CardTitle>
        ...
        <div className="mt-8 p-4 border border-gray-200 rounded-xl bg-white/50 backdrop-blur-sm shadow-soft">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs text-gray-500">Все данные актуальны</span>
            </div>
          </div>
        </div>
      </div>
