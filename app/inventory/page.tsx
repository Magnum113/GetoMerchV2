    ...
    <div className="space-y-6 p-4 md:p-6 lg:p-8 min-h-screen bg-muted/30">
      <div className="flex items-center justify-between">
        <div className="space-y-1">
          <h1 className="text-3xl font-bold tracking-tight text-foreground">Управление инвентарём</h1>
          <p className="text-muted-foreground">Отслеживание и управление уровнями товарных остатков</p>
        </div>
      ...
      <div className="grid gap-4 md:grid-cols-4">
        <Card className="border shadow-sm hover:shadow-md transition-all overflow-hidden group">
          <CardHeader className="flex flex-row items-center justify-between pb-3 pt-3 bg-muted/40">
            <CardTitle className="text-xs font-semibold text-muted-foreground uppercase tracking-wide">Всего товаров</CardTitle>
            <div className="h-10 w-10 rounded-lg bg-blue-500/10 flex items-center justify-center group-hover:bg-blue-500/20 transition-colors">
              <TrendingUp className="h-5 w-5 text-blue-600" />
            </div>
          </CardHeader>
          <CardContent className="pt-6">
            <div className="text-3xl font-bold text-foreground mb-1">{totalItems}</div>
            <p className="text-xs text-muted-foreground font-medium">В инвентаре</p>
          </CardContent>
        </Card>

        <Card className="border shadow-sm hover:shadow-md transition-all overflow-hidden group">
          <CardHeader className="flex flex-row items-center justify-between pb-3 pt-3 bg-muted/40">
            <CardTitle className="text-xs font-semibold text-muted-foreground uppercase tracking-wide">Всего остатков</CardTitle>
          ...
          <CardContent className="pt-6">
            ...
            <p className="text-xs text-muted-foreground font-medium">Единиц доступно</p>
          </CardContent>
        </Card>

        <Card className="border shadow-sm hover:shadow-md transition-all overflow-hidden group">
          <CardHeader className="flex flex-row items-center justify-between pb-3 pt-3 bg-muted/40">
            <CardTitle className="text-xs font-semibold text-muted-foreground uppercase tracking-wide">Зарезервировано</CardTitle>
          ...
          <CardContent className="pt-6">
            ...
            <p className="text-xs text-muted-foreground font-medium">Единиц зарезервировано</p>
          </CardContent>
        </Card>

        <Card className="border shadow-sm hover:shadow-md transition-all overflow-hidden group">
          <CardHeader className="flex flex-row items-center justify-between pb-3 pt-3 bg-muted/40">
            <CardTitle className="text-xs font-semibold text-muted-foreground uppercase tracking-wide">Предупреждения</CardTitle>
          ...
          <CardContent className="pt-6">
            ...
            <p className="text-xs text-muted-foreground font-medium">Позиций ниже минимума</p>
          </CardContent>
        </Card>
      </div>
            ...
            <Table>
              <TableHeader>
                <TableRow className="bg-muted/40 hover:bg-muted/40">
                  ...
                  <TableHead className="font-semibold text-foreground/90">Склад</TableHead>
                  <TableHead className="font-semibold text-foreground/90">В наличии</TableHead>
                  <TableHead className="font-semibold text-foreground/90">Зарезервировано</TableHead>
                  <TableHead className="font-semibold text-foreground/90">Доступно</TableHead>
                  <TableHead className="font-semibold text-foreground/90">Статус</TableHead>
                  <TableHead className="font-semibold text-foreground/90">Уровень остатков</TableHead>
                  ...
                  inventoryItems.map((item) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <TableCell className="py-4">
                          <span className="text-sm text-muted-foreground">{item.warehouse_location || "—"}</span>
                        </TableCell>
                        <TableCell className="py-4">
                        ...
                        <TableCell className="py-4">
                          <span className="text-sm text-muted-foreground font-medium">{item.quantity_reserved}</span>
                        </TableCell>
                        <TableCell className="py-4">
                        ...
                        <TableCell className="py-4">
                          <div className="w-28 space-y-1">
                            ...
                            />
                            <span className="text-xs text-muted-foreground font-medium">Мин: {item.min_stock_level}</span>
                          </div>
                        </TableCell>
                  ...
                  <TableRow>
                    <TableCell colSpan={9} className="text-center py-12">
                      <div className="flex flex-col items-center gap-3">
                        ...
                        <p className="text-sm text-muted-foreground font-medium">Позиции инвентаря не найдены</p>
                      </div>
                    </TableCell>
                  </TableRow>
                )}
