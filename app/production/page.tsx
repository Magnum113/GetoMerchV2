    ...
    <div className="space-y-6 p-4 md:p-6 lg:p-8 min-h-screen bg-muted/30">
      <div className="flex items-center justify-between">
        <div className="space-y-1">
          <h1 className="text-3xl font-bold tracking-tight text-foreground">Управление производством</h1>
          <p className="text-muted-foreground">Управление очередью производства и рецептами</p>
        </div>
      ...
      <div className="grid gap-4 md:grid-cols-4">
        <Card className="border shadow-sm hover:shadow-md transition-all overflow-hidden group">
          <CardHeader className="flex flex-row items-center justify-between pb-3 pt-3 bg-muted/40">
            <CardTitle className="text-xs font-semibold text-muted-foreground uppercase tracking-wide">Ожидает</CardTitle>
          ...
          <CardContent className="pt-6">
            <div className="text-3xl font-bold text-foreground mb-1">{pendingItems}</div>
            <p className="text-xs text-muted-foreground font-medium">Товаров в очереди</p>
          </CardContent>
        </Card>

        <Card className="border shadow-sm hover:shadow-md transition-all overflow-hidden group">
          <CardHeader className="flex flex-row items-center justify-between pb-3 pt-3 bg-muted/40">
            <CardTitle className="text-xs font-semibold text-muted-foreground uppercase tracking-wide">В производстве</CardTitle>
          ...
          <CardContent className="pt-6">
            ...
            <p className="text-xs text-muted-foreground font-medium">Производится сейчас</p>
          </CardContent>
        </Card>

        <Card className="border shadow-sm hover:shadow-md transition-all overflow-hidden group">
          <CardHeader className="flex flex-row items-center justify-between pb-3 pt-3 bg-muted/40">
            <CardTitle className="text-xs font-semibold text-muted-foreground uppercase tracking-wide">Завершено сегодня</CardTitle>
          ...
          <CardContent className="pt-6">
            ...
            <p className="text-xs text-muted-foreground font-medium">Товаров готово</p>
          </CardContent>
        </Card>

        <Card className="border shadow-sm hover:shadow-md transition-all overflow-hidden group">
          <CardHeader className="flex flex-row items-center justify-between pb-3 pt-3 bg-muted/40">
            <CardTitle className="text-xs font-semibold text-muted-foreground uppercase tracking-wide">Активные рецепты</CardTitle>
          ...
          <CardContent className="pt-6">
            <div className="text-3xl font-bold text-foreground mb-1">{recipes?.length || 0}</div>
            <p className="text-xs text-muted-foreground font-medium">Готовы к производству</p>
          </CardContent>
        </Card>
      </div>
