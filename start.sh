...
# GetoMerch - Скрипт быстрого запуска проекта (для терминала)
...
(sleep 5 && open http://localhost:3000/operations 2>/dev/null || echo "Откройте http://localhost:3000/operations в браузере") &
